...
namespace DeadLetterOffice.UI
{
    public class MapViewUI : MonoBehaviour
    {
        ...
        private void UpdatePlayerMarker()
        {
            ...
            float width = Mathf.Max(0.01f, _worldMax.x - _worldMin.x);
            float height = Mathf.Max(0.01f, _worldMax.y - _worldMin.y);
            ...
            _playerMarker.gameObject.SetActive(width > 0f && height > 0f);
        }
    }
}
